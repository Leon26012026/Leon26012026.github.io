...
            --bg-light: #0f172a;
 --Akzent: #38bdf8;
 --Akzent-weich: rgba(56, 189, 248, 0,15);
            --text: #e5e7eb;
 --gedämpft: #9ca3af;
 --Karte: #020617;
 --Radius: 16px;
 --Schatten: 0 18px 45px rgba(15, 23, 42, 0,7);
 --Abstand: 18px;
        }
...
        }
 ...
 Körper {
 Marge: 0;
 Schriftfamilie: system-UI, -apple-system, BlinkMacSystemFont, "Segoe UI", serifenlos;
 Hintergrund: Radialer Verlauf (Kreis oben, #1e293b 0, #020617 55 %, #000 100 %);
 Farbe: var(--text);
 Linienhöhe: 1,5;
        }
...
        .container {
 ...
 Marge: 0 Auto;
 Polsterung: 24px 18px 72px;
        }

 Header {
 Display: Flex;
 Ausrichtung-Elemente: Mitte;
 Justify-Content: Raum dazwischen;
 Lücke: 16 Pixel;
 Marge-Letzte: 32 Prozentpunkte;
        }
...
            aspect-ratio: 1 / 1; /* Quadratformat wie das App-Mockup */
            display: flex;
            align-items: center;
            justify-content: center;
            overflow: hidden;
...
            width: 100%;
            height: 100%;
            border-radius: 18px; /* Kleiner als der Wrapper-Radius */
            border: none;
            background: radial-gradient(circle at top left, rgba(56, 189, 248, 0.14), #020617);
        }
        /* ENDE NEUE STYLES FÜR HERO VIDEO */
...
            }
            /* Video füllt die volle Breite unter 880px */
            .hero-video-wrapper {
                aspect-ratio: 16 / 9;
            }
        }
...
                </a>
                <a href="#video-unten">
                    <button class="btn-ghost">Pitch-Video ansehen (mit Ton)</button>
                </a>
            </div>
...
            <iframe
                class="hero-right-video"
                src="https://www.youtube.com/embed/il_ueri6y8s?autoplay=1&mute=1&loop=1&playlist=il_ueri6y8s&controls=0&modestbranding=1"
...
        <section id="video-unten">
            <h2>Pitch-Video (mit Ton)</h2>
            <p class="section-subtitle">
...
    <iframe
        src="https://www.youtube.com/embed/il_ueri6y8s?modestbranding=1"
        title="ParkEase Pitch Video"
